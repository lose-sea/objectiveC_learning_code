...
- (void)test01 {
    ...
    UIBarButtonItem* leftBtn = [[UIBarButtonItem alloc] initWithTitle:@"Btn"
                                                                style:UIBarButtonItemStylePlain
                                                               target:self
                                                               action:@selector(pressTap)];
    self.navigationItem.leftBarButtonItem = leftBtn;

    UINavigationBarAppearance* navAppearance = [[UINavigationBarAppearance alloc] init];
    [navAppearance configureWithOpaqueBackground];
    navAppearance.backgroundColor = [UIColor greenColor];
    ...
    [toolAppearance configureWithOpaqueBackground];
    toolAppearance.backgroundColor = [UIColor yellowColor];
    toolAppearance.buttonAppearance.normal.titleTextAttributes = @{
        NSForegroundColorAttributeName: [UIColor redColor]
    };
